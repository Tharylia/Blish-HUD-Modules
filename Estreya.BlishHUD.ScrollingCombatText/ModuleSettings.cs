...
{
    public ModuleSettings(SettingCollection settings, SemVer.Version moduleVersion) : base(settings, moduleVersion, new KeyBinding(ModifierKeys.Alt, Keys.S)) { }
    ...
    public ScrollingTextAreaConfiguration AddDrawer(string name)
    {
        ...
        {
            // PLAYER_OUT
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.PHYSICAL,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "{{skill.Name}}: {{combatEvent.Value}} ({{destination.Name}})"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                ...
                Format = "<c=#ff0000>{{skill.Name}}: {{combatEvent.Value}} ({{destination.Name}})</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.BLEEDING,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#e84b30>{{combatEvent.Value}} ({{destination.Name}})</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.BURNING,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#ff9e32>{{combatEvent.Value}} ({{destination.Name}})</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.POISON,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#00c400>{{combatEvent.Value}} ({{destination.Name}})</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.CONFUSION,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#b243ff>{{combatEvent.Value}} ({{destination.Name}})</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.RETALIATION,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#ffed00>{{combatEvent.Value}} ({{destination.Name}})</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.TORMENT,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#501678>{{combatEvent.Value}} ({{destination.Name}})</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.DOT,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#45cdff>{{combatEvent.Value}} ({{destination.Name}})</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                ...
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#10FB10>{{skill.Name}} +{{combatEvent.Value}}</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.HOT,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#10FB10>{{skill.Name}} +{{combatEvent.Value}}</c>"
            ...
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.SHIELD_RECEIVE,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#ffff00>{{skill.Name}} +{{combatEvent.Value}}</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.SHIELD_REMOVE,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#ffff00>{{combatEvent.Value}} -=absorb=-</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                ...
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#0000ff>Block!</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.EVADE,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#0000ff>Evade!</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
                Type = CombatEventType.INVULNERABLE,
                State = CombatEventState.NORMAL,
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "<c=#0000ff>Invulnerable!</c>"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_OUT,
            ...
            new CombatEventFormatRule
            {
                ...
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "{{source.Name}}: {{combatEvent.Value}}"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PLAYER_IN,
            ...
            new CombatEventFormatRule
            {
                ...
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "{{combatEvent.Value}} ({{destination.Name}})"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PET_OUT,
            ...
            new CombatEventFormatRule
            {
                ...
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "{{skill.Name}} +{{combatEvent.Value}}"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PET_OUT,
            ...
            new CombatEventFormatRule
            {
                ...
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "{{combatEvent.Value}} -=absorb=-"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PET_OUT,
            ...
            new CombatEventFormatRule
            {
                ...
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "Pet {{skill.Name}}: {{combatEvent.Value}} ({{destination.Name}})"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PET_IN,
            ...
            new CombatEventFormatRule
            {
                ...
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "Pet {{combatEvent.Value}} ({{destination.Name}})"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PET_IN,
            ...
            new CombatEventFormatRule
            {
                ...
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "Pet {{skill.Name}} +{{combatEvent.Value}}"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PET_IN,
            ...
            new CombatEventFormatRule
            {
                ...
                TextColor = this.DefaultGW2Color,
                FontSize = ContentService.FontSize.Size16,
                Format = "Pet {{combatEvent.Value}} -=absorb=-"
            },
            new CombatEventFormatRule
            {
                Category = CombatEventCategory.PET_IN,
