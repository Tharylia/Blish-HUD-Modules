    ...
    public class ModuleSettings : BaseModuleSettings
    {
        ...
        public ScrollingTextAreaConfiguration AddDrawer(string name)
        {
            ...
            SettingEntry<List<CombatEventFormatRule>> formatRules = this.DrawerSettings.DefineSetting($"{name}-formatRules", new List<CombatEventFormatRule>()
            {
                ...
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.CRIT,            TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size18, Format = "{{skill.name}}: {{value}} ({{destination.name}})" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.BLEEDING,        TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{value}} ({{destination.name}})" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.BURNING,         TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{value}} ({{destination.name}})" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.POISON,          TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{value}} ({{destination.name}})" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.CONFUSION,       TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{value}} ({{destination.name}})" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.RETALIATION,     TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{value}} ({{destination.name}})" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.TORMENT,         TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{value}} ({{destination.name}})" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.DOT,             TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{value}} ({{destination.name}})" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.HEAL,            TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{skill.name}} +{{value}}" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.HOT,             TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{skill.name}} +{{value}}" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.SHIELD_RECEIVE,  TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{skill.name}} +{{value}}" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.SHIELD_REMOVE,   TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{value}} -=absorb=-" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.BLOCK,           TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "Block!" },
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.EVADE,           TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "Evade!" },
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.INVULNERABLE,    TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "Invulnerable!" },
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_OUT, Type = CombatEventType.MISS,            TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "Miss!" },
                ...
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_IN, Type = CombatEventType.HEAL,           TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{skill.name}} +{{value}}" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_IN, Type = CombatEventType.HOT,            TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{skill.name}} +{{value}}" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_IN, Type = CombatEventType.SHIELD_RECEIVE, TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{skill.name}} +{{value}}" } ,
                new CombatEventFormatRule() { Category = CombatEventCategory.PLAYER_IN, Type = CombatEventType.SHIELD_REMOVE,  TextColor = this.DefaultGW2Color, FontSize = ContentService.FontSize.Size16, Format = "{{value}} -=absorb=-" } ,
