namespace Estreya.BlishHUD.TradingPostWatcher.Controls
{
    ...
    public class TransactionArea : RenderTargetControl, IVisibilityChanging
    {
        ...
        public TransactionAreaConfiguration Configuration { get; private set; }
        ...
        private void AddTransaction(PlayerTransaction transaction)
        {
            ...
            if (!this.Configuration.ShowBuyTransactions.Value && transaction.Type is TransactionType.Buy) return;
            if (!this.Configuration.ShowSellTransactions.Value && transaction.Type is TransactionType.Sell) return;
        ...
        private Color GetTextColor(PlayerTransaction transaction)
        {
            Color defaultTextColor = this.Configuration.TextColor.Value.Id != 1
            ...
            return transaction.IsHighest
                ...
                : this.Configuration.OutbidTransactionColor.Value.Id != 1 ? this.Configuration.OutbidTransactionColor.Value.Cloth.ToXnaColor() : defaultTextColor;
        }
