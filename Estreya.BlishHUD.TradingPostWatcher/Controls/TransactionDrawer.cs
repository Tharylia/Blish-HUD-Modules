...
public class TransactionDrawer : FlowPanel
{
    ...
    private List<CurrentTransaction> _transactions = new List<CurrentTransaction>();
    ...
    private bool AddControl(CurrentTransaction transaction)
    {
    ...
    public bool AddTransaction(CurrentTransaction transaction)
    {
