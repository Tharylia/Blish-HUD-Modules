namespace Estreya.BlishHUD.UniversalSearch.UI.Views.Settings
{
    ...
    public class GeneralSettingsView : BaseSettingsView
    {
        ...
        protected override void BuildView(FlowPanel parent)
        {
            ...
            this.RenderBoolSetting(parent, _moduleSettings.NotifyOnCopy);
            this.RenderBoolSetting(parent, _moduleSettings.PasteInChatAfterCopy);
            this.RenderBoolSetting(parent, _moduleSettings.CloseWindowAfterCopy);
