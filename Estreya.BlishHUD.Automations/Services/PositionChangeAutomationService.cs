...
public class PositionChangeAutomationService : AutomationService<PositionChangeAutomationEntry, PositionChangeActionInput>
{
    private static TimeSpan _checkInterval = TimeSpan.FromMilliseconds(500);
    private double _lastCheck = 0;
    private Vector3 _lastPosition = Vector3.Zero;

    public PositionChangeAutomationService(ServiceConfiguration configuration, IFlurlClient flurlClient, Gw2ApiManager apiManager, IHandlebars handlebarsContext) : base(configuration, flurlClient, apiManager, handlebarsContext) { }
