...
public class Skill : IDisposable
{
    ...
    ///     Can be resolved against <see cref="IGw2WebApiV2Client.Skills" />.
    ///     If the skill does not have a next skill in the chain, or if the skill is not part of a skill chain at all, this
    ...
    ///     Can be resolved against <see cref="IGw2WebApiV2Client.Skills" />.
    ///     If the skill does not have a previous skill in the chain, or if the skill is not part of a skill chain at all, this
    ///     value is <see langword="null" />.
    /// </summary>
    ...
    [JsonIgnore] public AsyncTexture2D IconTexture { get; set; }
